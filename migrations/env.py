...
def include_object(object, name: str, type_, reflected, compare_to) -> bool:
    """
    A function which is given the chance to return True or False for
    any object, indicating if the given object should be considered in the
    autogenerate sweep.
    ...
    Args:
        ...
        type_: a string describing the type of object; currently "table", "column", "index", "unique_constraint", or "foreign_key_constraint"
